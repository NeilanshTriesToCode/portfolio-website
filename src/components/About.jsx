...
const About = () => {
  ...
  return (
    <section id='about' className='hide-content xl:min-h-[85vh]'>
        <div className='mx-auto px-10 py-20 container flex flex-col items-center  md:flex-row '>
          ...
          <TypeWriter text={"I'm Neilansh"} />
            ...
            Originally from <span className='text-white font-medium'>Ahmedabad, India,</span> I'm a 
            <span className='text-white font-medium'> Computer Science</span> graduate at 
            ...
            and like creating <span className='text-white font-medium'> interactive and dynamic UIs.</span>
